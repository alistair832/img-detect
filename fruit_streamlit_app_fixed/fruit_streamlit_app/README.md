...
> For Streamlit Community Cloud deployment, use `requirements.txt`. For local training, use `requirements-training.txt`.
...
For cloud deployment, see `DEPLOY_STREAMLIT_CLOUD.md`. The deployment configuration uses `tensorflow-cpu==2.20.0` and is designed for Python 3.12.
